...
export default function SignIn() {
  ...
  return (
    <div className="grid place-items-center h-screen">
      <div className="shadow-lg p-5 rounded-lg border-t-4 border-green-400 flex flex-col gap-3">
        ...
        <button onClick={handleGoogle} className="bg-blue-500 text-white font-bold cursor-pointer px-6 py-2 rounded-md">
          Sign in with Google
        </button>
